<template>
  ...
  <section id="header" class="bg-[#F8FAFC]" x-data="{ open: false }">
   ...
   />
            ...
            <span @click="cropImageAndSave">Save Image</span>
                  ...
                  <div class="w-auto p-4">
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="flex-1 p-2">
                        <h3 class="text-lg font-semibold">Target Image</h3>
                      </div>
                      <div class="w-full p-2">
                        <div class="pb-8 border-b">
      ...
      <aside
      class="z-20 flex shrink-0 grow-0 justify-around gap-4 border-t border-gray-200 bg-white/50
       p-2.5 shadow-lg backdrop-blur-lg dark:border-slate-600/60 dark:bg-slate-800/50 fixed top-1/4 
